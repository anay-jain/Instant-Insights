...
def getTweets(query):
    # authenticating
    consumerKey= 'AB5xRKsEv04phNrSgNNUwwHrs'
    consumerSecret= 'mIEmt1bFdpf5ckSS3iz3p3Ip93h7sFgk5kwE3pfQzQiknQqdKE'
    accessToken='2707272738-xAkDoKNkdQPaeMYL7ZGiTKImdZEmNcueoi33gci'
    accessTokenSecret='1zGCv0ejvMbnEOxyXtdaboIp0cOkyCq6E8JrTZQFDtsUd'
